...
def main():
    ...
    send_bloom(
        writer_access_token,
        "In this essay I will convince you my views are correct in ways you never imagined. If it doesn't change your life, read it again. Marshmallows are magnificent—great squish, tasty, and perfect toasted with a crisp outside and melty middle."
        )
